                ...
                {isPremium ? (
                  ...
                  <div className="text-center py-2">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#F46A6A] text-white text-sm font-semibold rounded-full hover:bg-[#e55d5d] active:bg-[#d45252] transition-colors"
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="lg:w-80 shrink-0 space-y-5">
              ...
              {isPremium ? (
                ...
                <div className="bg-linear-to-br from-[#fff5f5] to-[#fdf0f0] rounded-2xl p-6 border border-[#F46A6A]/10">
                  ...
                  <a
                    href="/dashboard?tab=shop"
                    className="inline-block text-xs font-semibold text-[#F46A6A] hover:underline"
                  >
                    Learn more →
                  </a>
                </div>
